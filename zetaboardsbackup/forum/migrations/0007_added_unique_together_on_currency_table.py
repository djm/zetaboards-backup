...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CurrencyTable', fields ['to_currency', 'from_currency']
        db.create_unique('library_currencytable', ['to_currency', 'from_currency'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CurrencyTable', fields ['to_currency', 'from_currency']
        db.delete_unique('library_currencytable', ['to_currency', 'from_currency'])
