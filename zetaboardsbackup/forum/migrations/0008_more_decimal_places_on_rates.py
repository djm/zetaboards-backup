...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CurrencyTable.rate'
        db.alter_column('library_currencytable', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=6))


    def backwards(self, orm):
        
        # Changing field 'CurrencyTable.rate'
        db.alter_column('library_currencytable', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))
